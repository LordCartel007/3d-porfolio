...
import ContactExperience from "../sections/ContactExperience.jsx";
    ...
    <section id="contact" className="flex-center section-padding">
      <div className="w-full h-full md:px-10 px-5">
        ...
        <div className="grid-12-cols mt-16">
          ...
          <div className="contactcomputer xl:col-span-7 min-h-96">
            {!isMobile && (
              <div className=" bg-[#FFFDD0] w-full h-full hover:cursor-grab rounded-3xl overflow-hidden">
                <ContactExperience />
              </div>
            )}
          </div>
